	...
	function ebor_custom_metaboxes( $meta_boxes ) {
		...
		$meta_boxes[] = array(
			...
			'fields' => array(
				...
				array(
				    'name'             => 'Enable/Disable Image and Text Area',
				    'desc'             => '',
				    'id'               => $prefix . 'menu_show_image',
				    'type'             => 'select',
				    'show_option_none' => false,
				    'default'          => 'show_image_area',
				    'options'          => array(
				    	'show_image_area' => 'Show Text/Image Area',
				    	'hide_image_area' => 'Hide Text/Image Area',
				    ),
				),
			)
		);
