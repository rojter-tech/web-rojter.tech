...
if(!( function_exists('ebor_breadcrumbs') )){ 
	function ebor_breadcrumbs() {
		...
		if( is_blog_page() && is_single() ){
			$breadcrumb .= '<li><a href="' . esc_url( get_permalink( get_option( 'page_for_posts' ) ) ) . '">' . wp_specialchars_decode( get_option('stack_blog_title', 'Highlighted Articles') ) . '</a></li><li class="active">' . wp_specialchars_decode( get_the_title( $post->ID ) ) . '</li>';
		} elseif( is_blog_page() ){
			$breadcrumb .= '<li class="active">' . wp_specialchars_decode( get_option('stack_blog_title','Highlighted Articles') ) . '</li>';
