<!--META--><section class="vim" id="variant-gallery-lightbox" vbr="Gallery Simple" vbp="gallery">
<section class=" ">
            ...
            <div class="masonry">
                ...
                <div class="masonry__container">
                    <div class="masonry__item col-md-4 col-xs-6 voh vnn" data-masonry-filter="People">
                        <a href="<?php variant_page_builder_demo_img('work-6.jpg'); ?>">
                            <img alt="Image" src="<?php variant_page_builder_demo_img('work-6.jpg'); ?>">
                        </a>
                    </div>
                    <div class="masonry__item col-md-4 col-xs-6 voh vnn" data-masonry-filter="People">
                        <a href="<?php variant_page_builder_demo_img('work-3.jpg'); ?>">
