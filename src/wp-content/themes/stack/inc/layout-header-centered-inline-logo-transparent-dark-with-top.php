...
<div class="nav-container">
	...
	<nav id="menu1" class="bar bar-2 hidden-xs bar--dark bar--absolute bar--transparent <?php echo esc_attr($background); ?>" <?php echo wp_kses_post($scroll); ?>>
		<div class="container">
			<div class="row">
				...
				<div class="col-md-5 text-right text-left-xs text-left-sm">
					<?php get_template_part('inc/content-header', 'nav-right'); ?>
				</div>
			</div><!--end of row-->
		</div><!--end of container-->
	</nav><!--end bar-->
