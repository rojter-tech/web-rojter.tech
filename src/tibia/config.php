<?php
	...
	*/
	...
	$config['client_download'] = 'https://github.com/rojter-tech/rojtertibia/releases/download/v0.6.3-windows/otclient-x86.zip';
	$config['client_download_linux'] = 'https://github.com/rojter-tech/rojtertibia/releases/download/v0.6.3-linux/rojter-tibia-client.zip';
	...
	$config['gameserver'] = array(
		'ip' => '83.250.0.97',
		'port' => 7172,
		'name' => 'rOjterTibia' // Must be identical to config.lua (OT config file) server name.
	);
